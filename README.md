...
### Step 1: Configure Your School Info
1. Run the settings tool (`SchoolWallpaperSettings.exe`) in the main folder.
2. Type your **School Name** and click **Search**. Select your school from the results list.
3. Enter your **Grade** and **Class** numbers.
4. Click **Save and Apply Now** to apply the wallpaper immediately!
...
4. In the Actions step, select **Start a Program** and browse to `SchoolWallpaperSettings.exe`. In the **Add arguments (optional)** field, add `--background` so it runs silently in the background.
